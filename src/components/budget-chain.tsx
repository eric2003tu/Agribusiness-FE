...
import { APPROVAL_STEP_LABELS, type Budget } from "@/lib/mock-data";
...
export function BudgetChainProgress({ budget }: { budget: Budget }) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      {budget.steps.map((step, i) => {
        ...
        const isCurrent = i === budget.currentStepIndex && budget.status === "pending";
        return (
