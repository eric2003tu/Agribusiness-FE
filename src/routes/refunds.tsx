...
export const Route = createFileRoute("/refunds")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Review and resolve buyer refund requests." },
    ],
  }),
...
function RefundsPage() {
  const { transactions, userById, resolveRefund } = useWorkspace();
  ...
  return (
    <AppShell
      allowedRoles={["admin"]}
      title="Refunds"
      description="Review buyer refund requests and resolve them."
    >
